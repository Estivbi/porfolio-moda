        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-moda-rose rounded-full flex items-center justify-center hover:bg-moda-pink transition-colors">
                <svg className="w-5 h-5 text-moda-dark" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-moda-gray flex items-center">
