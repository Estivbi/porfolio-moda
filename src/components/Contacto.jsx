        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-moda-pink-dark">hola@ejemplo.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-moda-rose rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-moda-pink-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-moda-pink-dark">+34 123 456 789</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-moda-rose rounded-full flex items-center justify-center">
                  <svg className="w-5 h-5 text-moda-pink-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-moda-pink-dark">Madrid, España</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-12 h-12 bg-moda-rose rounded-full flex items-center justify-center hover:bg-moda-pink transition-colors">
                <svg className="w-6 h-6 text-moda-pink-dark" fill="currentColor" viewBox="0 0 24 24">
